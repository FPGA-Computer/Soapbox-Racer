...
/* Driver constants.                                                         */
/*===========================================================================*/
#define SPI_POLLING_LIMIT     8
#define SPI_IGNORE_SENDBYTE   0xffff
...
typedef struct {
  ...
  __IO uint32_t   *Port;            // GPIO PDOR
  uint8_t         CS_Mask;          // Chip select bitmask
  uint8_t         CS_Enable;        // Enable bitmask
  uint8_t         CS_Disable;       // Disable bitmask
...
struct SPIDriver {
  ...
  int8_t                    DMA_Rx;   // DMA channels Rx
  int8_t                    DMA_Tx;   // DMA channels Tx    
